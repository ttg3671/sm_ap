...
import { Outer, ContentCardList, Navbar } from "../../components";
    ...
    useEffect(() => {
        ...
        const getSeries = async () => {
            try {
                ...
                const response = await axiosPrivate.get(`/api/v1/admin/season/${season}/episodes?pgNo=${page}&page_items=${itemsPerPage}`, {
                        ...
                        {isLoading ? (
                            ...
                            contentList.length > 0 ? (
                                contentList.map((content, index) => (
                                    <ContentCardList key={index} contentList={content} tagList={tags} season={season} handleDelete={handleDelete} />
                                ))
                            ) : (
